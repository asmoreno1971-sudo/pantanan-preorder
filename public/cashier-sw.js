const cacheName = "roadworthy-cashier-shell-shared-source-v14";
...
const installShellUrls = [
  ...
  "/admin.js?v=current",
  "/app.js?v=current",
  "/app-shell-offline.js?v=current",
  "/cashier-fast.js?v=current",
  "/cashier-offline.js?v=current",
  "/expenses.js?v=current",
  "/guidance.css?v=current",
  "/guidance.js?v=guidance-cleanup-v14",
  "/guidance-report.css?v=current",
  "/guidance-report.js?v=guidance-cleanup-v14",
  "/kitchen.js?v=current",
  "/teacher-login.css?v=current",
  "/teacher-login.js?v=current",
  "/learner-offline.js?v=guidance-cleanup-v14",
  "/mineralex/styles.css",
  "/mineralex/script.js",
  "/page-auth.js?v=current",
  "/personnel.css?v=current",
  "/personnel.js?v=current",
  "/personnel-profile.css?v=current",
  "/personnel-profile.js?v=current",
  "/qr.js?v=current",
  "/sales.js?v=current",
  "/student-dashboard.css?v=current",
  "/student-dashboard.js?v=current",
  "/students.css?v=current",
  "/students.js?v=current",
  "/teacher-accounts.css?v=current",
  "/teacher-accounts.js?v=current",
  "/teacher-session.css?v=current",
  "/teacher-session.js?v=current",
  "/transactions.js?v=current",
